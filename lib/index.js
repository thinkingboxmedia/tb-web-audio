...
function WebAudio() {
	...
	this.load = function (src) {
		var onload = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];
		var onended = arguments.length <= 2 || arguments[2] === undefined ? null : arguments[2];
		var autoplay = arguments.length <= 3 || arguments[3] === undefined ? true : arguments[3];
		var loop = arguments.length <= 4 || arguments[4] === undefined ? true : arguments[4];
